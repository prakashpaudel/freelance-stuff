...
<section class="sans-articles">
	<div class="wrapper">
        ...
        <div class="clear"></div>
            	<a name="list"></a>
		<section id="sans-main-container" class="clearfix">
        	<div class="blog-left">
				
                <div class="blog-sub-title">TAG: <span> <?php single_tag_title();?></span></div>
            ...
            <div class="blog-right">
                ...
                <div class="clearfix" id="cat-list">
                	<ul class="ul-no-style blog-categires font-14">
                	<?php
